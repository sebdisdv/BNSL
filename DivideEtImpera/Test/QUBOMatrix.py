...
def calcQUBOMatrixForDivideEtImpera(parameters= None):
  #get and calculate values
  n = parameters["n"]
  parentSets = parameters["parentSets"]
  w = parameters["w"]
  deltaMax = parameters["deltaMax"]
  deltaTrans = parameters["deltaTrans"]
  deltaConsist = parameters["deltaConsist"]
